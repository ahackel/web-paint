  ...
  */
  ...
  var $5458ccc97f312ae7eb3d522c6e47d7ad$export$default = /*#__PURE__*/function (_View) {
    ...
    function PaintView(id, onBackClicked) {
      ...
      _this = _super.call(this, id);
      $5458ccc97f312ae7eb3d522c6e47d7ad$var$_defineProperty($5458ccc97f312ae7eb3d522c6e47d7ad$var$_assertThisInitialized(_this), "pixelPerfect", false);
      $5458ccc97f312ae7eb3d522c6e47d7ad$var$_defineProperty($5458ccc97f312ae7eb3d522c6e47d7ad$var$_assertThisInitialized(_this), "imageSmoothing", true);
    ...
    $5458ccc97f312ae7eb3d522c6e47d7ad$var$_createClass(PaintView, [{
      ...
      value: function createButtons(onBackClicked) {
        ...
        $221dd0966d34bf75372b465b73e7e2f6$export$default.addFastClick(this._undoButton, function () {
          return _this2.undo();
        });
      }
    }, {
      ...
      value: function createTools() {
        this._tools = [new $6acec9c96facd444f912da51a32889dd$export$default(this, "darken"), new $6acec9c96facd444f912da51a32889dd$export$default(this, "source-over"), new $6acec9c96facd444f912da51a32889dd$export$default(this, "destination-out"), new $0b7612a3c8ef25d3ffb929cb842ce3e6$export$default(this)];
      ...
      value: function createPalettes() {
        ...
        this._colorPalette = new $5dca99d43a8c97d91bd7a455231d3c8c$export$default("color-palette");
        ...
        this._toolPalette = new $9fd885faf3605f16c885551b80589177$export$default("tool-palette");
        ...
        this._sizePalette = new $ec78efd7806a8105310c4515b254a117$export$default("size-palette");
      ...
      value: function move(timeStamp, isPainting, mouse, pressure) {
        ...
        var newMouse = mouse;
        var delta = $92dd1d4feee990cfd982aa729623e7fc$export$default.distance(this._currentTool.mouse, newMouse);

        if (delta > 2) {
          var timeDelta = timeStamp - this._timeStamp;
          this._timeStamp = timeStamp;
          var speed = delta / timeDelta;
          this._currentTool.speed = $221dd0966d34bf75372b465b73e7e2f6$export$default.lerp(this._currentTool.speed, speed, 0.2);
      ...
      value: function saveImage() {
        ...
        this._ctx.canvas.toBlob(function (blob) {
          return $45b85264923af8e8796436f758852a1d$export$default.saveImage(_this6._imageId, blob);
        });
      }
    }, {
      key: "show",
  ...
  $5458ccc97f312ae7eb3d522c6e47d7ad$var$_defineProperty($5458ccc97f312ae7eb3d522c6e47d7ad$export$default, "getPointerEventPaintingFlag", function (e) {
