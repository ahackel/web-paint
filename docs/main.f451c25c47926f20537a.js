...
var ShapePalette = /*#__PURE__*/function (_Palette) {
  ...
  function ShapePalette(id) {
    ...
    _this = _super.call(this, id, _config__WEBPACK_IMPORTED_MODULE_2__.config.defaultShapes, true);
    _this._shapeIds = {};
...
/* harmony export */   "getImageOverlayUrl": function() { return /* binding */ getImageOverlayUrl; },
...
function getImageOverlayUrl(id) {
  ...
  return (_config$images$id = _config__WEBPACK_IMPORTED_MODULE_0__.config.images[id]) === null || _config$images$id === void 0 ? void 0 : _config$images$id.overlay;
}
  ...
  _createClass(PaintView, [{
    ...
    value: function loadImage(id) {
      ...
      return _storage_ImageStorage__WEBPACK_IMPORTED_MODULE_7__.imageStorage.loadImage(id).then(function (image) {
        ...
        _this6.setOverlay(_utils_Utils__WEBPACK_IMPORTED_MODULE_3__.getImageOverlayUrl(id));
...
var SettingsView = /*#__PURE__*/function (_View) {
  ...
  function SettingsView(id, onBackClicked) {
    ...
    _utils_Utils__WEBPACK_IMPORTED_MODULE_1__.addClick(exportButton, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var zipBlob;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
    ...
    _utils_Utils__WEBPACK_IMPORTED_MODULE_1__.addClick(importButton, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.t0 = _storage_ImageStorage__WEBPACK_IMPORTED_MODULE_2__.imageStorage;
              _context2.next = 3;
...
var Thumbnail = /*#__PURE__*/function () {
  function Thumbnail(parent, id, onImageSelected) {
    ...
    this.overlayUrl = _utils_Utils__WEBPACK_IMPORTED_MODULE_0__.getImageOverlayUrl(id);
