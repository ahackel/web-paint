        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                userId = _context.t2;
                receipients = ["Andreas", "Juri", "Jutta", "Lila"].filter(function (x) {
                  return x != userId;
                });
...
var DropboxStorage = /*#__PURE__*/function () {
  ...
  _createClass(DropboxStorage, [{
    ...
    key: "startSync",
    value: function () {
      var _startSync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
        var cursor;
    ...
    key: "sync",
    value: function () {
      var _sync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
        var cursor;
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              ...
              case 6:
                ...
                return _context17.abrupt("return", cursor);
    ...
    key: "syncFolder",
    value: function () {
      var _syncFolder = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(serverPath, clientPath) {
            ...
            switch (_context19.prev = _context19.next) {
              ...
              case 11:
                fileSync = new _utils_FileSync__WEBPACK_IMPORTED_MODULE_4__.FileSync(clientFiles, serverFiles, fileSyncStatus, /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(id) {
...
var SelectionTool = /*#__PURE__*/function (_Tool) {
  ...
  function SelectionTool(painter, buttonId) {
    ...
    _this._sendPalette.onSelectionChanged = function (receipient) {
      _this.selectionLayer.canvas.toBlob( /*#__PURE__*/function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  _this._sendPalette.bounce();

                  _context.next = 7;
                  break;

                case 6:
                  _this._sendPalette.shake();
  ...
  _createClass(SelectionTool, [{
    ...
    key: "setImageUrl",
    value: function () {
      var _setImageUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
        var _this2 = this;
    ...
    key: "setImagePath",
    value: function () {
      var _setImagePath = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(path) {
        var url;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                url = _context3.sent;
                return _context3.abrupt("return", this.setImageUrl(url));
    ...
    value: function () {
      var _saveSelectionAsNewShape = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var shapes, path;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
...
var SettingsView = /*#__PURE__*/function (_View) {
    ...
    _utils_Utils__WEBPACK_IMPORTED_MODULE_1__.addClick(_this._syncButton, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _storage_DropboxStorage__WEBPACK_IMPORTED_MODULE_5__.dropboxStorage.toggleSync();
  ...
  _createClass(SettingsView, [{
    ...
    value: function updateButtons() {
      ...
      this._syncButton.innerHTML = '<i class="fas fa-sync fa-fw"></i> ' + (_storage_DropboxStorage__WEBPACK_IMPORTED_MODULE_5__.dropboxStorage.isSyncing ? "Stop Sync" : "Start Sync");
    }
  }, {
    key: "show",
    value: function show() {
