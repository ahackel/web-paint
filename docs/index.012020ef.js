...
var PaintView = /*#__PURE__*/function (_View) {
  ...
  function PaintView(id, onBackClicked) {
    ...
    _defineProperty(_assertThisInitialized(_this), "pixelPerfect", true);
    ...
    _this._colorPalette = new _ColorPalette.default("color-palette");
