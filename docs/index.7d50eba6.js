  ...
  _createClass(ImageStorage, null, [{
    ...
    get: function get() {
      if (this._adapter == null) {
        this._adapter = new _LocalForageAdapter.default();
      }
...
var PaintView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaintView, [{
    ...
    value: function pointerMove(event) {
      ...
      var pressure = event.pointerType == "pen" ? _Utils.default.clamp(0.5, 1, event.pressure * 2) : 1;
...
var PenTool = /*#__PURE__*/function (_Tool) {
  ...
  _createClass(PenTool, [{
    ...
    value: function getWidth() {
      var pressure = _Utils.default.clamp(0.5, 2, this.pressure * 2);

      var speed = _Utils.default.clamp(1, 5, this.speed);
...
//# sourceMappingURL=index.7d50eba6.js.map
