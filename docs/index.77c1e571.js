...
})({"4eOkr":[function(require,module,exports) {
"use strict";

var _BookView = _interopRequireDefault(require("./views/BookView"));

var _PaintView = _interopRequireDefault(require("./views/PaintView"));
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    this.paintView = new _PaintView.default("paint", function () {
...
var app = new App();
},{"./views/BookView":"5SOzm","./views/PaintView":"03pUo"}],"5SOzm":[function(require,module,exports) {
"use strict";
...
var _ImageStorage = _interopRequireDefault(require("../storage/ImageStorage"));
...
},{"./View":"6dl5u","../config":"4APP3","../utils/Utils":"6sm6f","../storage/ImageStorage":"2mJ3S"}],"6dl5u":[function(require,module,exports) {
"use strict";
...
exports.View = View;
},{}],"4APP3":[function(require,module,exports) {
"use strict";
...
},{}],"6sm6f":[function(require,module,exports) {
"use strict";
...
},{"./Point":"5nWRj"}],"5nWRj":[function(require,module,exports) {
"use strict";
...
},{}],"2mJ3S":[function(require,module,exports) {
"use strict";
...
var _LocalForageAdapter = _interopRequireDefault(require("./LocalForageAdapter"));
...
var ImageStorage = /*#__PURE__*/function () {
  ...
  _createClass(ImageStorage, null, [{
    ...
    value: function loadImageFromStore(id) {
      ...
      return this._adapter.getItem(id).then(function (blob) {
        if (!blob) {
    ...
    value: function saveImage(id, blob) {
      return this._adapter.setItem(id, blob).then(function () {
        ...
        _Utils.default.DispatchEventToAllElements(event);
      });
    }
  }, {
    key: "imageKeys",
    ...
    value: function iterate(callback) {
      ...
      return this._adapter.iterate(function (blob, id, iteration) {
        if (blob) {
...
},{"./LocalForageAdapter":"4hrBW","../utils/Utils":"6sm6f"}],"4hrBW":[function(require,module,exports) {
"use strict";
...
var _StorageAdapter2 = _interopRequireDefault(require("./StorageAdapter"));
...
var LocalForageAdapter = /*#__PURE__*/function (_StorageAdapter) {
  ...
  function LocalForageAdapter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_imageStore", _localforage.default.createInstance({
      name: "ImageStore"
    }));
...
},{"localforage":"3qwSG","./StorageAdapter":"THpo1"}],"3qwSG":[function(require,module,exports) {
var define;
...
},{}],"THpo1":[function(require,module,exports) {
"use strict";
...
},{}],"03pUo":[function(require,module,exports) {
"use strict";
...
var _ColorPalette = _interopRequireDefault(require("../palettes/ColorPalette"));

var _ToolPalette = _interopRequireDefault(require("../palettes/ToolPalette"));

var _SizePalette = _interopRequireDefault(require("../palettes/SizePalette"));
...
var _Palette = require("../palettes/Palette");
  ...
  _createClass(PaintView, [{
    ...
    value: function createButtons(onBackClicked) {
      ...
      _Utils.default.addFastClick(clearButton, function () {
        return _this2.clear(true);
      });

      this._undoButton = document.getElementById("undo-button");

      _Utils.default.addFastClick(this._undoButton, function () {
        return _this2.undo();
      });
    }
  }, {
    ...
    value: function createTools() {
      this._tools = [new _PenTool.default(this, "darken"), new _PenTool.default(this, "source-over"), new _PenTool.default(this, "destination-out"), new _PaintBucketTool.default(this)];
    ...
    value: function createPalettes() {
      ...
      this._sizePalette = new _SizePalette.default("size-palette");
    ...
    value: function move(timeStamp, isPainting, mouse, pressure) {
      ...
      var delta = _Point.default.distance(this._currentTool.mouse, newMouse);

      if (delta > 2) {
        var timeDelta = timeStamp - this._timeStamp;
        this._timeStamp = timeStamp;
        var speed = delta / timeDelta;
        this._currentTool.speed = _Utils.default.lerp(this._currentTool.speed, speed, 0.2);
    ...
    value: function loadImage(id) {
      ...
      return _ImageStorage.default.loadImage(id).then(function (image) {
        _this5._imageId = id;
    ...
    value: function saveImage() {
      ...
      this._ctx.canvas.toBlob(function (blob) {
        return _ImageStorage.default.saveImage(_this6._imageId, blob);
      });
    }
  }, {
    key: "show",
...
_defineProperty(PaintView, "getPointerEventPaintingFlag", function (e) {
  return e.pointerType === "touch" ? true : e.buttons === 1;
});
},{"./View":"6dl5u","../palettes/ColorPalette":"5F8W2","../palettes/ToolPalette":"2nsOM","../palettes/SizePalette":"4akH2","../utils/Utils":"6sm6f","../tools/PenTool":"75aeR","../tools/PaintBucketTool":"7COXJ","../utils/Point":"5nWRj","../palettes/Palette":"2WAqZ","../storage/ImageStorage":"2mJ3S"}],"5F8W2":[function(require,module,exports) {
"use strict";
...
},{"./Palette":"2WAqZ"}],"2WAqZ":[function(require,module,exports) {
"use strict";
...
},{"../views/View":"6dl5u","../utils/Utils":"6sm6f"}],"2nsOM":[function(require,module,exports) {
"use strict";
...
},{"./Palette":"2WAqZ"}],"4akH2":[function(require,module,exports) {
"use strict";
...
},{"./Palette":"2WAqZ"}],"75aeR":[function(require,module,exports) {
"use strict";
...
var PenTool = /*#__PURE__*/function (_Tool) {
  ...
  _createClass(PenTool, [{
    ...
    value: function move() {
      ...
      this._widths.push(_Utils.default.clamp(lastWidth - 1, lastWidth + 1, width));
    ...
    value: function getWidth() {
      return this.lineWidth * _Utils.default.clamp(0.3, 1, this.pressure / this.speed);
    }
  }]);
...
},{"./Tool":"0Ya6m","../utils/Point":"5nWRj","../utils/Utils":"6sm6f"}],"0Ya6m":[function(require,module,exports) {
"use strict";
...
},{"../utils/Point":"5nWRj"}],"7COXJ":[function(require,module,exports) {
"use strict";
...
var PaintBucketTool = /*#__PURE__*/function (_Tool) {
  ...
  _createClass(PaintBucketTool, [{
    ...
    value: function down() {
      ...
      _Utils.default.floodFill(ctx, this.mouse, this.painter.color);
    }
  }]);
...
},{"./Tool":"0Ya6m","../utils/Utils":"6sm6f"}]},{},["4eOkr"], "4eOkr", "parcelRequireb491")

//# sourceMappingURL=index.77c1e571.js.map
