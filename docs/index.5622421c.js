...
},{"./views/BookView":"2qj3L","./views/PaintView":"1Zutj","./config":"1tzQg","./views/SettingsView":"5P39T","@parcel/transformer-js/lib/esmodule-helpers.js":"7jvX3","babel-polyfill":"57WP1"}],"2qj3L":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
var PenTool = /*#__PURE__*/(function (_Tool) {
  ...
  function PenTool(painter, buttonId) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_lastTangent", new _utilsPointDefault.default(1, 0));
  ...
  _createClass(PenTool, [{
    ...
    value: function drawRandomPixelLine(ctx, start, end) {
      ...
      var altitude = Math.max(Math.abs(start.tilt.x), Math.abs(start.tilt.y));
      start.width = _utilsUtilsDefault.default.lerp(3, 100, Math.pow(altitude / 90, 4));
      end.width = start.width;
      var averageWidth = 0.5 * (start.width + end.width);
      var pixelSize = _utilsUtilsDefault.default.clamp(2, 12, averageWidth * 0.5);
      ...
      for (var i = 0; i < pixelCount; i++) {
        ...
        var offset = _utilsPointDefault.default.scale(normal, radius * _utilsUtilsDefault.default.lerp(-1, 1, Math.pow(Math.random(), 3)));
        position.add(offset);
        if (_config.config.pixelPerfect) {
          position.round();
          size = Math.ceil(size);
    ...
    value: function getPosition(position, tilt, width) {
      ...
      return _utilsPointDefault.default.add(position, _utilsPointDefault.default.scale(tilt, tiltInfluence * 0.5 * width / 90));
    }
  }, {
    key: "applyAutoMask",
...
},{}],"57WP1":[function(require,module,exports) {
"use strict";
var global = arguments[3];
...
//# sourceMappingURL=index.5622421c.js.map
